...
from vortosql.pipeline.example_selector.question_similarity import (
    QuestionSimilarity,
    ...
    def execute(self, context: dict[str, Any]) -> None:
        try:
            ...
            technique_map = {
                ...
                ExampleSelectionTechnique.QUESTION_SIMILARITY: (
                    self._select_example_by_question_similarity
                ),
            }
